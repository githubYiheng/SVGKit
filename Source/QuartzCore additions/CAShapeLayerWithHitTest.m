...
{
    BOOL boundsContains = CGRectContainsPoint(self.expend ? [self expandedBounds] : self.bounds, p); // must be BOUNDS because Apple pre-converts the point to local co-ords before running the test
